...
type SubscribeUpdateTransactionInfo struct {
	...
	Transaction   *ConfirmedBlock_Transaction           `protobuf:"bytes,3,opt,name=transaction,proto3" json:"transaction,omitempty"`
	Meta          *ConfirmedBlock_TransactionStatusMeta `protobuf:"bytes,4,opt,name=meta,proto3" json:"meta,omitempty"`
...
func (x *SubscribeUpdateTransactionInfo) GetTransaction() *ConfirmedBlock_Transaction {
	if x != nil {
		return x.Transaction
	}
	return nil
...
func (x *SubscribeUpdateTransactionInfo) GetMeta() *ConfirmedBlock_TransactionStatusMeta {
	if x != nil {
		return x.Meta
	}
	return nil
...
type SubscribeUpdateBlock struct {
	...
	Rewards                  *ConfirmedBlock_Rewards           `protobuf:"bytes,3,opt,name=rewards,proto3" json:"rewards,omitempty"`
	BlockTime                *ConfirmedBlock_UnixTimestamp     `protobuf:"bytes,4,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`
	BlockHeight              *ConfirmedBlock_BlockHeight       `protobuf:"bytes,5,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
...
func (x *SubscribeUpdateBlock) GetRewards() *ConfirmedBlock_Rewards {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *SubscribeUpdateBlock) GetBlockTime() *ConfirmedBlock_UnixTimestamp {
	if x != nil {
		return x.BlockTime
	}
	return nil
...
func (x *SubscribeUpdateBlock) GetBlockHeight() *ConfirmedBlock_BlockHeight {
	if x != nil {
...
func (x *SubscribeUpdateBlockMeta) GetRewards() *ConfirmedBlock_Rewards {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *SubscribeUpdateBlockMeta) GetBlockTime() *ConfirmedBlock_UnixTimestamp {
	if x != nil {
		return x.BlockTime
	}
	return nil
...
func (x *SubscribeUpdateBlockMeta) GetBlockHeight() *ConfirmedBlock_BlockHeight {
	if x != nil {
		return x.BlockHeight
	}
	return nil
...
const file_geyser_proto_rawDesc = "" +
	"\n" +
	"\fgeyser.proto\x12\x06geyser\x1a\x14solana-storage.proto\"\xe7\t\n" +
	...
	"\ftransactions\x18\x03 \x03(\v2*.geyser.SubscribeRequest.TransactionsEntryR\ftransactions\x12<\n" +
	...
	"\x02id\x18\x01 \x01(\x05R\x02id\"\x87\x04\n" +
	...
	"\vtransaction\x18\x04 \x01(\v2\".geyser.SubscribeUpdateTransactionH\x00R\vtransaction\x124\n" +
	...
	"\x05index\x18\x05 \x01(\x04R\x05index\"\xcd\x05\n" +
	...
	"\aentries\x18\r \x03(\v2\x1c.geyser.SubscribeUpdateEntryR\aentries\"\xb4\x03\n" +
	...
	"\x1aexecuted_transaction_count\x18\b \x01(\x04R\x18executedTransactionCount\"\xb1\x01\n" +
	...
	"\x1aexecuted_transaction_count\x18\x05 \x01(\x04R\x18executedTransactionCount\"\x15\n" +
	...
	"\n" +
	"GetVersion\x12\x19.geyser.GetVersionRequest\x1a\x1a.geyser.GetVersionResponse\"\x00B\bZ\x06/protoP\x00b\x06proto3"
...
var file_geyser_proto_goTypes = []any{
	...
	(*ConfirmedBlock_Transaction)(nil),                 // 41: solana.storage.ConfirmedBlock.Transaction
	(*ConfirmedBlock_TransactionStatusMeta)(nil),       // 42: solana.storage.ConfirmedBlock.TransactionStatusMeta
	(*ConfirmedBlock_Rewards)(nil),                     // 43: solana.storage.ConfirmedBlock.Rewards
	(*ConfirmedBlock_UnixTimestamp)(nil),               // 44: solana.storage.ConfirmedBlock.UnixTimestamp
	(*ConfirmedBlock_BlockHeight)(nil),                 // 45: solana.storage.ConfirmedBlock.BlockHeight
}
...
func file_geyser_proto_init() {
	...
	file_geyser_proto_msgTypes[24].OneofWrappers = []any{}
